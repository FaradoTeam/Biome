...
public:
    ...
    void setDocumentService(std::shared_ptr<services::IDocumentService> service);
    void setCommentService(std::shared_ptr<services::ICommentService> service);
    void setCommentDocumentService(std::shared_ptr<services::ICommentDocumentService> service);
    ...
    void setItemDocumentService(std::shared_ptr<services::IItemDocumentService> service);
    ...
    void setSpecialDayService(std::shared_ptr<services::ISpecialDayService> service);
    void setStandardDayService(std::shared_ptr<services::IStandardDayService> service);
    ...
    void setUserDayService(std::shared_ptr<services::IUserDayService> service);
...
private:
    ...
    std::shared_ptr<services::IItemHistoryService> m_itemHistoryService;
    std::shared_ptr<services::IItemLinkService> m_itemLinkService;
    std::shared_ptr<services::IItemTypeService> m_itemTypeService;
    std::shared_ptr<services::IItemUserStateService> m_itemUserStateService;
