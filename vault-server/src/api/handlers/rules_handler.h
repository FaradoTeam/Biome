...
public:
    ...
    void handleGetRules(const web::http::http_request& request, const std::string& userId);
    void handleGetRule(const web::http::http_request& request, const std::string& userId);
    void handleCreateRule(const web::http::http_request& request, const std::string& userId);
    void handleUpdateRule(const web::http::http_request& request, const std::string& userId);
    void handleDeleteRule(const web::http::http_request& request, const std::string& userId);
